...
@php
    $country = App\Country::where('id', $order->get_dshipping->first()->country);
    $country = $country->first()->name;
    $state = App\State::where('id', $order->get_dshipping->first()->state);
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <a href="{{route('sa.dorder.pdf.download', ['order_id' => $order->id])}}" class="pdf_btn link btn btn-success mt-2" type="button">
                  ...
                  <div class="card-body">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                                <p>{{$order->get_dshipping->first()->address}},
                                    {{$order->get_dshipping->first()->zip_code}},
                                    {{$order->get_dshipping->first()->city}}, {{$state}}, {{$country}}.
                                </p>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <tbody class="tbody">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @endphp
                                                000{{$order->get_user->id }}AM{{$acronym}}
                                            </td>
                                ...
                                <table class="table table-responsive" border="2px">
                                    ...
                                    <tbody class="tbody">
                                        ...
                                        <tr>
                                            <td scope="row">{{$item->get_dproducts->id}}</td>
                                            <td>{{$item->get_dproducts->name}}</td>
                                            <td>{{$item->dproduct_qty}}</td>
                                            <td>${{number_format($item->get_dproducts->d_price,2)}}</td>
                                            <td>${{number_format($item->get_dproducts->d_price * $item->dproduct_qty,2)}}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
