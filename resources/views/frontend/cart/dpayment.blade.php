        ...
        <div class="row mb-3">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                ...
                <form action="{{ route('thank.you') }}" method="get" id='payment-form-id'>
                    ...
                    <div class="row ">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <button type="submit" class="btn btn-info form-control net_btn">
                                ...
                                <div class="container">
                                    <div class="row ">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                            ...
                                            <input type='hidden' id='card-billing-first-name' name='card-billing-first-name' value="{{$order->get_dshipping->first()->fname}}"/>
                                            <input type='hidden' id='card-billing-last-name' name='card-billing-last-name' value="{{$order->get_dshipping->first()->lname}}"/>
                                            <input type='hidden' id='card-billing-address' name='card-billing-address' value="{{$order->get_dshipping->first()->address}}"/>
                                            <input type='hidden' id='card-billing-address-city' name='card-billing-address-city' value="{{$order->get_dshipping->first()->city}}"/>
                                            <input type='hidden' id='card-billing-address-zip_code' name='card-billing-address-zip_code' value="{{$order->get_dshipping->first()->zip_code}}"/>
                                            <input type='hidden' id='card-billing-address-country_name' name='card-billing-address-country_name' value="{{$order->get_dshipping->first()->country}}"/>
                                            <input type='hidden' id='card-billing-address-state_name' name='card-billing-address-state_name' value="{{$order->get_dshipping->first()->state}}"/>
            ...
            return actions.order.capture().then(function(details) {
                ...
                $.ajax({
                    ...
                    success: function (data)
                    {
                        ...
                        var url = 'http://asliimall.com/dthank-you/'+id;
