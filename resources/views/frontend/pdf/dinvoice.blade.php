     ...
     <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="padding: 10px 0 30px 0;">
                   ...
                   <table  align="center" border="0" cellpadding="0" cellspacing="0" width="500" style="border: 0px solid #cccccc; border-collapse: collapse;">
                    <tr>
                 ...
                 <table class="table" align="center" border="0" cellpadding="0" cellspacing="0" width="500" style="    padding: 28px 0px;">
                                    <tr>
                                        <td width="33.33%">
                  ...
                  <table class="table" align="center" border="0" cellpadding="0" cellspacing="0"  width="500">
                     ...
                     <table class="table" align="center" border="1" cellpadding="0" cellspacing="0" width="500" style="margin-top:30px">
                                    <tr>
                                ...
                                <table class="table" align="center" border="1" cellpadding="0" cellspacing="0" width="500" style="margin-top: 30px; margin-bottom: 5px;">
                                     <tr>
                                        <th bgcolor="#F35901" style="font-size:12px;text-align: center; color: #ffffff;     padding: 12px 8px;">
                                          ITEM ID
                                        </th>
                  ...
                  <table class="table" align="center" border="0" cellpadding="0" cellspacing="0" width="500" >
                   ...
                   <table class="table" align="center" border="0" cellpadding="0" cellspacing="0" width="500" style="margin-top: 60px;">
                                    <tr>
