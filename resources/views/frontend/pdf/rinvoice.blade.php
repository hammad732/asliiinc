    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="padding: 10px 0 30px 0;">
                ...
                <table class="table" align="center" border="0" cellpadding="0" cellspacing="0" width="500"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;" width="33.33%">
                            ...
                            <h4 style="margin-top: 0px; margin-bottom: 5px; color:#F35901">{{$connects->email}}</h4>
                            <h4 style="margin-top: 0px; margin-bottom: 5px; color:#F35901">{{$connects->phone_no}}</h4>
                        </td>
                        <td style="text-align: center;" width="33.33%">
                            <h3 style="margin-top: 18px; margin-bottom: 5px; background-color: #F35901; color:#FFFFFF">
                    ...
                    <tr>
                        <td style="text-align: center;" width="250">
                            ...
                            <h4 style="margin-top: 0px; margin-bottom: 10px;color:#F35901">
                                ...
                                {{ $order->get_rshipping->first()->city }},<br>
                                {{ $state }},
                                {{ $country }},
                ...
                <table class="table" align="center" border="1" cellpadding="0" cellspacing="0" width="500"
                    style="margin-top:30px">
                    <tr>
                        <th bgcolor=" #F35901"
                            style="font-size:12px;text-align: center; color: #ffffff;     padding: 12px 8px;">
                            ORDER ID
                        </th>
                        <th bgcolor="#F35901"
                            style="font-size:12px;text-align: center; color: #ffffff;     padding: 12px 8px;">
                        ...
                        <th bgcolor="#F35901"
                            ...
                            TOTAL PRICE
                                    ...
                                    <td style="text-align: center; color:#F35901; padding: 8px 10px;">
                                        {{$item->get_rproducts->item_id}}
                                    </td>
                                    <td style="text-align: center; color:#F35901; padding: 8px 10px;">
                                        {{$item->get_rproducts->name}}
                                    </td>
                                    <td style="text-align: center; color:#F35901; padding: 8px 10px;">
                                        {{$item->rproduct_qty}}
                                    </td>
                                    <td style="text-align: center; color:#F35901; padding: 8px 10px;" >
                                        {{-- @if ($item->rproduct_id ==$item->r_varient_id)
                                            {{$item->get_rproducts->r_weight}}
                                            @else
                                            @foreach ($item->get_rproducts->variant as $variant)                         
                                                @if ($variant->id == $item->r_varient_id) 
                                    ...
                                    <td style="text-align: center;  color:#F35901;   padding: 8px 10px;">
                                        $ {{number_format($item->rproduct_pirce,2)}}
                                    </td>
                                    <td style="text-align: center;  color:#F35901;   padding: 8px 10px;">
                                        $ {{number_format($item->rproduct_pirce * $item->rproduct_qty,2)}}
                                    </td>
                                </tr>
                            @endforeach
                ...
                <table class="table" align="center" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style=""><br>
                            <h4 style="margin-top: 0px; margin-bottom: 0px;color:#F35901;">Note: please make a check
                                payable to Asli Inc</h4><br>
                            <h4 style="margin-top: 0px; margin-bottom: 0px;color:#F35901;">Payment Mailing Address: {{$connects->address}}</h4><br>
                            <p style="margin-top: 0px; margin-bottom: 0px;color:#F35901;"><b>Recommendation:</b> </p>
                            <br>
                            ...
                            <p style="margin-top: 0px; margin-bottom: 0px;color:#F35901;"><b>Shipping /
                                    DELIVERY:</b><br>
                            </p>
                ...
                {{-- <table class="table" align="center" border="0" cellpadding="0" cellspacing="0" width="500"
                    ...
                    <tr>
                        <td style="text-align: center;">
                            <h3 style="margin-top: 0px; margin-bottom: 5px; background-color: #F35901;color:#FFFFFF;">
                                Head Office</h3>
                        ...
                        <td style="text-align: center;">
                            <h3 style="margin-top: 0px; margin-bottom: 5px; background-color: #F35901;color:#FFFFFF">
                                Sales and Distribution</h3>
                            <p style="margin-top: 0px; margin-bottom: 0px;color:#F35901;">D-402, Shree Darshan
                                Chandlodia,</p>
                            <p style="margin-top: 0px; margin-bottom: 0px;color:#F35901;">Daskroi, Ahmadabad Gujrat,
                                India </p>
                        </td>
                        <td style="text-align: center;">
                            <h3 style="margin-top: 0px; margin-bottom: 5px; background-color: #F35901;color:#FFFFFF">
                            ...
                            <p style="margin-top: 0px; margin-bottom: 0px;color:#F35901;">Gulshan-E- Shehbaz Park
                                Lahore, Pakistan </p>
                        </td>
                    </tr>
                </table> --}}
