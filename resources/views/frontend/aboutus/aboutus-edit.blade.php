            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <h1 class="text-center text-dark"><b>Edit About Us</b></h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                            ...
                            <form action="{{route('aboutus.update')}}" method="post" enctype="multipart/form-data">
                               ...
                               <input type="hidden" name="id" value="{{$service->id}}">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                        <label class="mt-1" for="banner_title">About Us Heading:</label>
                                        <input type="text" class="form-control" name="banner_title" id="heading" value="{{$service->banner_title}}" placeholder="Heading" required>
                                    </div>
                                ...
                                <hr>   
                                 ...
                                 <div class="row mb-2">
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                        <label class="mt-1" for="banner_image">Upload Image: </label>
                                   
                                        <input type="file" class="form-control" name="banner_image" id="image" accept="image/*">
                                    </div>
                                ...
                                <div class="row mb-2">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                        ...
                                        <textarea name="text" id="text" >{!!$service->text!!} </textarea>
