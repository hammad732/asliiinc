            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <h1 class="text-center text-dark"><b>Add New Type</b></h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <form action="{{route('service-type.save')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                                        <label class="mt-1" for="heading">Service Type Heading:</label>
                                        <input type="text" class="form-control" name="type" id="type" value="{{old('type')}}" placeholder="Service Type Heading" required>
                                    </div>
